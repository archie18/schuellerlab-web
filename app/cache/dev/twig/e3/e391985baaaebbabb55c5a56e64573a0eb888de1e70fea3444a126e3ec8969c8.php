...
/* @LDMMain/DrSASA/running.html.twig */
class __TwigTemplate_66ac4ffd0124136b85425cbe90c29c6e8cdaf3f438578cb40a772a2c61ee8be4 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("@LDMMain/baseUser.html.twig", "@LDMMain/DrSASA/running.html.twig", 1);
        $this->blocks = array(
    ...
    public function block_main_header($context, array $blocks = array())
    {
        ...
        <div class=\"col-lg-12\">
            <h2>
                <span class=\"text-navy\"><i>dr_sasa</i> - Running</span>
            </h2>
            <ol class=\"breadcrumb\">
                <li class=\"active\">
                    <a href=\"";
...
";
    ...
    {
        return "@LDMMain/DrSASA/running.html.twig";
    }
...
{% block main_header %}
    <div class=\"row wrapper border-bottom white-bg page-heading\">
        <div class=\"col-lg-12\">
            ...
            <ol class=\"breadcrumb\">
                <li class=\"active\">
                    <a href=\"{{ path('ldm_home') }}\">dr_sasa</a>
                </li>
            </ol>
        </div>
    </div>
        ...
        <div class=\"col-lg-10 col-lg-offset-1\">
            <div class=\"ibox float-e-margins m-t-xl\">
                <div class=\"ibox-content text-left p-lg\">
                    ...
                    <p>
                        <a href=\"{{ path('ldm_dr_sasa_results', {'token': token}) }}\">{{ app.request.getSchemeAndHttpHost() }}{{ path('ldm_dr_sasa_results', {'token': token}) }}</a>
                    </p>
                    <p>Refreshing page...</p>
                    <div class=\"progress\">
                        <div style=\"width: 0%\" aria-valuemax=\"100\" aria-valuemin=\"0\" aria-valuenow=\"0\" role=\"progressbar\" class=\"progress-bar progress-bar-success\">
...
{% endblock %}
", "@LDMMain/DrSASA/running.html.twig", "/var/www/schuellerlab-web/src/LDM/MainBundle/Resources/views/DrSASA/running.html.twig");
    }
}
