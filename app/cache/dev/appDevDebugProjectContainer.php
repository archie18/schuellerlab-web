...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'schueller', 'user' => 'schueller', 'password' => '1234five', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_fec0db7ca70abc0846f1295125a70a5e4edb8af4f07caafb3db2ef0a5138485e');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('melolabtest@gmail.com');
        $a->setPassword('m3l0p4ss');
        $a->setAuthMode('login');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'views/Form/bootstrap_3_layout_LDM.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/LDM/MainBundle/Resources/views'), 'LDMMain');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1124d94d66bc9d5sadas12fd816ef5af03aeedf1e3232321412fasvdv');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5c9e14ddbfa70')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LDMMainBundle' => 'LDM\\MainBundle\\LDMMainBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'schueller',
            'database_user' => 'schueller',
            'database_password' => '1234five',
            'mailer_transport' => 'gmail',
            'mailer_user' => 'melolabtest@gmail.com',
            'mailer_password' => 'm3l0p4ss',
            'mailer_port' => NULL,
            'mailer_encryption' => NULL,
            'mailer_host' => NULL,
            'secret' => '1124d94d66bc9d5sadas12fd816ef5af03aeedf1e3232321412fasvdv',
            'dr_sasa.bash' => '/bin/bash',
            'dr_sasa.run_script' => 'dr_sasa.sh',
            'dr_sasa.binary' => 'dr_sasa',
            'dr_sasa.python' => '/Library/Frameworks/Python.framework/Versions/2.7/bin/python2.7',
            'dr_sasa.contactplot' => 'contactplot.py',
            'targpred_newdescfp' => 'newDescfp.sh',
            'targpred_tanmat2' => 'tanmat2',
            'targpred_chembl24' => 'Chembl24_goldStd3_max.txt.smi.fpt.bin',
            'targpred_chembl_newdesc' => 'ChEMBL24desc_vs_NEWdesc_fp2.tanmat',
            'targpred_test' => 'test.sh',
            'targpred_query' => 'targpredQuery',
            'targpred_chembl24_co' => 'Chembl24_goldStd3_max.txt.co',
            'targpred_query_co' => 'query.txt.co',
            'targpred_babel' => '/usr/local/bin/babel',
            'locale' => 'en',
            ...
            'kernel.secret' => '1124d94d66bc9d5sadas12fd816ef5af03aeedf1e3232321412fasvdv',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'views/Form/bootstrap_3_layout_LDM.html.twig',
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'melolabtest@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'm3l0p4ss',
